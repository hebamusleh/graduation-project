  ...
  return (
    <header className="rounded-4xl relative top-4 z-20 mx-auto flex w-full max-w-7xl items-center justify-between bg-white px-4 py-2 shadow-lg sm:px-10 sm:py-4">
      ...
      <nav className="flex items-center gap-3 sm:gap-6">
        <Button className="w-24 rounded-full border border-blue-600 py-1 text-center text-sm font-medium text-blue-600 transition-colors hover:bg-blue-50 sm:w-32 sm:py-2 sm:text-base">
